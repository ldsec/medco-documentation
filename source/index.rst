...
- MedCo software repositories
    - `MedCo Connector <https://github.com/lca1/medco-connector>`_
    - `Unlynx Wrapper <https://github.com/lca1/medco-unlynx>`_
    - `Unlynx Javascript Crypto Library <https://github.com/lca1/medco-unlynx-js>`_
    - `Data Loader <https://github.com/lca1/medco-loader>`_
    - `Glowing Bear MedCo <https://github.com/lca1/glowing-bear-medco>`_ (forked from `The Hyve <https://github.com/thehyve/glowing-bear>`_)
    - `Deployment <https://github.com/lca1/medco-deployment>`_
    - `Documentation <https://github.com/lca1/medco-documentation>`_
...
- Deprecated repositories
    - `IRCT <https://github.com/lca1/IRCT>`_ (forked from `HMS-DBMI <https://github.com/hms-dbmi/IRCT>`_)
    - `I2B2 Cell <https://github.com/lca1/medco-i2b2-cell>`_
